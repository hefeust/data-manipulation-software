...
//                const bag_infos = bags_lookup.get(uid) || []             
                const role_name = bag_infos.role.role_name
                const role_value  = bag_infos.part.role_value

                bag[role_name] = role_value    
            })
