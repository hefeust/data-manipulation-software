    ...
    const install_items = async (bag, with_data) => {
        ...
        for (const record of records) {
            ...
            for (const entry of record) {
                ...
                let part_block = uncache_part(kn_uid, entry.part_uid) || await pool.get_data(entry.part_uid)
...
//                parts_cache.set(entry.keyname, part_block)
            ...
            if(counter === 0) {
                ...
                for (const entry of record) {
                    ...
                    const part_block = uncache_part(kn_uid, part_uid)
